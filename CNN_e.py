...
for p1 in pooling:
  for s1 in size:
    ...
    for p2 in pooling:
      ...
      with open('{}/{}/model_summary_pl1_{}sl1_{}_pl2_{}sl2_{}.txt'.format(file_loc, start, p1,s1, p2, s2), 'w') as fr:
...
df = pd.DataFrame(list(zip(accuracy_list, run_time_list, pool_list1, size_list1, pool_list2, size_list2)),columns =['accuracy', 'run_time', 'pool1', 'size1','pool2', 'size2'])

...
for o in optimizer:
  for l in loss_function:
    ...
    with open('{}/{}/model_summary_opt_{}_loss{}.txt'.format(file_loc, start, o, l), 'w') as fr:
...
df = pd.DataFrame(list(zip(accuracy_list, run_time_list, optimizer_list, loss_list)),columns =['accuracy', 'run_time', 'optimizer', 'loss'])
